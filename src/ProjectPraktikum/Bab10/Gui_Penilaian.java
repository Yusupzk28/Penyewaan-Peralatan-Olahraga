...
public void koneksi() throws SQLException {
    ...
    "jdbc:mysql://localhost:3306/oop_2318038?useSSL=false&serverTimezone=UTC",
    "root",
    "");
...
public double NilaiAkhir() {
    ...
    public void itempilih() {
     ...
     nim1 = table_data.getValueAt(row, 0).toString();
     kd_mk1 = table_data.getValueAt(row, 1).toString();

     // Set isi combo box dan field sesuai baris yang diklik
     cmbNim.setSelectedItem(nim1);
     cmbKodeMk.setSelectedItem(kd_mk1);

     txtNP1.setText(table_data.getValueAt(row, 2).toString());
     txtNP2.setText(table_data.getValueAt(row, 3).toString());
     txtUts.setText(table_data.getValueAt(row, 4).toString());
     txtNP3.setText(table_data.getValueAt(row, 5).toString());
     txtPraktikum.setText(table_data.getValueAt(row, 6).toString());
     txtUas.setText(table_data.getValueAt(row, 7).toString());
     txtNA.setText(table_data.getValueAt(row, 8).toString());

     // Bisa ditambahkan jika ingin reset keaktifan
...
public void cari() {
    ...
    private void initComponents() {
        ...
        cmbNim = new javax.swing.JComboBox<String>();
        cmbKodeMk = new javax.swing.JComboBox<String>();
